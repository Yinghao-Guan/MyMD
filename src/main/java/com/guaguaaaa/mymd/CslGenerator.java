...
public class CslGenerator {
    ...
    private static String parseTemplate(String template) {
        // 1. 先处理粗体 **text** -> <group font-weight="bold">text</group>
        // 注意：必须先处理双星号，否则会被单星号正则误伤
        ...
        // 2. 再处理斜体 *text* -> <group font-style="italic">text</group>
        ...
        String[][] replacements = {
                ...
                {"{doi}", "<text variable=\"DOI\"/>"} // 移除强制前缀，让用户自己决定
        };
